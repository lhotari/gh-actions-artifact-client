...
test('download test', async () => {
  ...
  mockserver.get('/download').reply(200, 'Hello, world!', {
    'Content-Length': 13
  })
  ...
  mockserver.post('/twirp/github.actions.results.api.v1.ArtifactService/GetSignedArtifactURL').query(true).reply(200, {
