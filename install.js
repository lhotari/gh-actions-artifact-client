...
${clientJsContent}`,
  ...
  console.log(
    `Copied index.js as executable ${clientJsPath} with embedded ACTIONS_RUNTIME_URL, ACTIONS_RESULTS_URL and ACTIONS_RUNTIME_TOKEN environment variables copied from environment.`
  )
